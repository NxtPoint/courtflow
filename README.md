...
| **Verification gates** | `python -m scripts.test_all` → current baseline: **booking 637 / billing 718 / statement 64** (rollback-only scratch-DB harnesses; there is no pytest suite). |
