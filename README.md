...
| **Verification gates** | `python -m scripts.test_all` → current baseline: **booking 404 / billing 579 / statement 64** (rollback-only scratch-DB harnesses; there is no pytest suite). |
