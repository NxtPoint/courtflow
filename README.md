...
| **Verification gates** | `python -m scripts.test_all` → current baseline: **booking 405 / billing 663 / statement 64** (rollback-only scratch-DB harnesses; there is no pytest suite). |
