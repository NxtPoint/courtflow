...
| **Verification gates** | `python -m scripts.test_all` → current baseline: **booking 474 / billing 693 / statement 64** (rollback-only scratch-DB harnesses; there is no pytest suite). |
