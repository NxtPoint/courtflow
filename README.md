...
| **Verification gates** | `python -m scripts.test_all` → current baseline: **booking 592 / billing 702 / statement 64** (rollback-only scratch-DB harnesses; there is no pytest suite). |
