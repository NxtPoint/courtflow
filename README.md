...
| **Verification gates** | `python -m scripts.test_all` → current baseline: **booking 455 / billing 686 / statement 64** (rollback-only scratch-DB harnesses; there is no pytest suite). |
