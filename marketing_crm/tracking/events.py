...
PACK_LOW = "pack_low"   # a session pack dropped to 1 remaining → drives the top-up flow (E3)
...
EVENTS = {
    ...
    LESSON_COMPLETED,
    PAYMENT_SUCCEEDED, MONTHLY_STATEMENT_READY, MEMBERSHIP_STARTED, MEMBERSHIP_LAPSED, PACK_LOW,
